...
from .auth import router, JWT_SECRET_KEY, JWT_ALGORITHM, create_access_token, verify_token
...
class TestGitHubCallback:
    ...
    def test_github_callback_success(self, mock_supabase, mock_requests_get, mock_requests_post):
        ...
        mock_table.select.return_value.eq.return_value.execute.return_value = mock_existing_user

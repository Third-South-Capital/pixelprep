        ...
        <div className="text-center space-y-4">
            ...
            <div className="space-y-4">
              <div className="text-center">
                ...
                <p className="text-indigo-700 text-lg">
                  Keep the momentum going! Optimize another image and see the magic happen again.
                </p>
              </div>

              <button
                onClick={onReset}
                className="group relative bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-12 py-4 rounded-2xl font-bold text-xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center mx-auto"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-indigo-400 rounded-2xl opacity-0 group-hover:opacity-30 transition-opacity"></div>
                <svg className="w-6 h-6 mr-3 group-hover:animate-spin relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
                <span className="relative z-10">Optimize Another Image</span>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent rounded-2xl transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"></div>
              </button>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="group bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-2 rounded-xl font-medium text-sm transition-colors flex items-center"
            >
